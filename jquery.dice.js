        ...
        $(that.diceImage).css({
            ...
            height:(that.diceSize*4) + "px"
                ...
                if( that.rollFrame++ % 9 != 0 ) {
                    ...
                    that.showValue(rnd);
                    value_dice_1 = window.localStorage.setItem("value_dice1",_dices[0].value);
                    value_dice_2 = window.localStorage.setItem("value_dice2",_dices[1].value);
                }
            }, complete:function(){
                that.inRoll = false;
    ...
    $.fn.dice = function(elems, opt, cb){
        if( typeof elems == "string"){
            ...
            return $(this).each(function(){
                ...
                window._dices[0].width = 200;
                window._dices[0].height = 200;
